...
const FeedbackPage = ({navigation, route}) => {
  ...
  const onSubmit = () => {
    axios.all([
      axios.post(`${ENDPOINT_API_SMART_CANTEEN}tenant/rating/${id_tenant}`, data1),
      axios.post(`${ENDPOINT_API_SMART_CANTEEN}tenant/updatePerhitunganAkhir/${id_tenant}`, datab),
      axios.post(`${ENDPOINT_API_SMART_CANTEEN}tenant/updateTotalJumlahOrder/${id_tenant}`, datac)
